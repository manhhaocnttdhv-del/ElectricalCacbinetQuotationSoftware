...
{
    /// <summary>
    /// SQL DDL cho 2 bảng ECQ_BuildConfig + ECQ_BuildConfigItem (cùng FK + index).
    /// Tách riêng để DatabaseService gọn.
    /// </summary>
    internal static class EcqBuildConfigSchema
    {
        /// <summary>Script CREATE TABLE + FK + INDEX (idempotent: chỉ tạo nếu chưa tồn tại).</summary>
